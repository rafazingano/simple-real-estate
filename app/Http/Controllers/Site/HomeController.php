...
class HomeController extends Controller
{
    public function index()
    {
    	...
    	$slides = Slide::where('publicado', '=', 'sim')->orderBy('ordem', 'desc')->get();
    	...
    	return view('site.home', compact('imoveis', 'slides', 'direcaoTexto', 'paginacao', 'tipos', 'cidades'));
    }
    ...
    public function busca(Request $request)
    {
		...
		$imoveis = Imovel::where('publicar', '=', 'sim')->where($testeStatus)->where($testeTipo)->where($testeCidade)->where([$testeDormitorios[$numDormitorios]])->where($testeValor[$numValor])->where($testeBairro)->orderBy('id', 'desc')->get();
